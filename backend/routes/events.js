...
// Trazabilidad completa: Ninguna ruta es accesible sin validación previa.
router.use(protect);

// --- 2. DEFINICIÓN DE RUTAS OPERATIVAS (ORDEN CRÍTICO) ---
// IMPORTANTE: Las rutas estáticas van ANTES de las rutas con parámetros (:id)

/**
 * @route    GET /api/events/active-map
 * @desc     Obtener misiones de VUELO TÁCTICO en curso para el Mapa (Sincro Real-Time)
 */
 ...
 * @desc     Obtener lista de eventos (Calendario General y Monitor filtrado por unidad)
 */
