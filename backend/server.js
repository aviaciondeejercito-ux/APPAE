 ...
 * Actualización: Integración de Proxy METAR/TAF (metar.js).
 */
...
app.use(helmet({
    contentSecurityPolicy: false, // Necesario para cargar capas de mapas y datos externos
}));
...
// Límite de carga para prevenir ataques DoS
...
const server = app.listen(PORT, () => {
    ...
    console.log(`📡 Módulos activos: /api/auth, /api/events, /api/admin, /api/aircraft, /api/weather`);
});
