...
const Vuelos = () => {
    ...
    const misiones = ["Entrenamiento","Transporte de Personal", "Transporte de Carga", "Sanitario", "Rappel", "Fast Rope", "Carga Externa", "Helibalde", "NVG", "Lanzamiento de Paracaidistas", "Lanzamiento de Carga", "Lanzamiento de Buzos", "Tiro Aereo","Tiro de Apuntador de Puerta", "Visual Nocturno", "IFR", "Instruccion", "Calificacion","Habilitacion","Mantenimiento","Aerodesembarco"];
